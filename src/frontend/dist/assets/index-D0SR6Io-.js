...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white font-body", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-6 bg-white opacity-30" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href: "#menu",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "bg-charcoal text-white p-4 sticky top-0 z-40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto flex justify-between items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xl font-bold tracking-tighter font-heading", children: [
        "DAWAT ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold", children: "RESTAURANT" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex gap-8 text-sm uppercase font-semibold", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl md:text-6xl font-bold mb-4 leading-tight font-heading", children: [
            "Sagar's Favorite Destination for",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold", children: "Authentic Non-Veg" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg md:text-xl mb-8 opacity-90", children: "From flavorful Chicken Dum Biryani to sizzling Kebabs — enjoy bold taste and unbeatable value." }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 flex flex-wrap justify-center gap-6 text-sm font-semibold opacity-80", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "w-4 h-4 text-gold" }),
              " Famous Dum Biryani"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "w-4 h-4 text-gold" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-20 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto grid md:grid-cols-2 gap-12 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold mb-6 border-l-4 border-maroon pl-4 text-charcoal font-heading", children: "Welcome to Dawat Restaurant" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg leading-relaxed mb-6", children: [
          "Located near ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Jhhula Tigadda, Tilak Ganj" }),
          ", Dawat Restaurant is a trusted name in Sagar for rich flavors and satisfying meals at affordable prices."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg leading-relaxed mb-6", children: "Every dish, from our aromatic biryani to mouth-watering kebabs, is prepared with meticulous attention to freshness and quality. Whether you're a local or a traveler, we ensure a meal that keeps you coming back." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg overflow-hidden shadow-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bg-gray-50 py-20 px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto text-center mb-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold text-charcoal uppercase tracking-widest font-heading", children: "The Dawat Restaurant Experience" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8", children: [
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Flame, { className: "text-maroon mb-4 w-10 h-10" }),
          title: "Signature Biryani",
          desc: "Packed with rich aroma and authentic spices, our Chicken Dum Biryani is a legend."
        },
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "text-maroon mb-4 w-10 h-10" }),
          title: "Quick Service",
          desc: "Fast preparation ensures minimal waiting time for your hunger cravings."
        },
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { className: "text-maroon mb-4 w-10 h-10" }),
          title: "Early Morning",
        ...
        "div",
        {
          ...
          children: [
            card.icon,
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold mb-2 font-heading", children: card.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: card.desc })
          ]
        },
        card.title
      )) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "menu", className: "py-20 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold mb-12 text-center underline decoration-gold underline-offset-8 font-heading", children: "Our Popular Dishes" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-4 gap-8", children: menuCategories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "h3",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3 font-semibold text-charcoal", children: cat.items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "li",
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "location", className: "py-20 bg-charcoal text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6 grid md:grid-cols-2 gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold mb-6 text-gold font-heading", children: "Visit Us" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-start gap-4 text-lg", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "text-gold mt-1 shrink-0" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-start gap-4 text-lg", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "text-gold mt-1 shrink-0" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-64 bg-gray-600 rounded-lg flex items-center justify-center italic text-gray-400", children: "[ Google Map Embed Area ]" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-black text-white py-12 px-6 border-t border-gray-800", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold mb-2 font-heading", children: "Dawat Restaurant & Fast Food" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gold italic mb-8", children: "Authentic Taste. Real Satisfaction." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-500 text-sm", children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Dawat Restaurant Sagar. All Rights Reserved."
      ] }),
...
Service({
  "getRestaurantInfo": Func([], [RestaurantInfo], ["query"])
});
